                ...
                <div className="home-elem-2">
                    <div className="home-elem-3">
                        <span className="home-elem-4">
                            <p>Stay Hassle-Free with Claim Pro Assist. </p>
                        </span>
                    </div>
            ...
            <div className="home-elem-20">
                <div className="home-elem-21">
                    <div className="home-elem-22">
                        <i className="fas fa-award home-elem-23"></i>
                        <span className="home-elem-24">
                            <p>Awarded Best</p>
                        </span>
                    </div>
                ...
                <div className="home-elem-30">
                    ...
                    <div className="home-elem-35">
                        <span className="home-elem-36">
                            <img src="https://res.cloudinary.com/dbyioi2qq/q_auto/v1706005175/static/free-picavif_1706005174_73331.avif" />
                        </span>
                        <span className="home-elem-37">
                            <img src="https://res.cloudinary.com/dbyioi2qq/image/upload/v1705836234/bcypdrvrxorsi1erceru.jpg" />
                        </span>
                    </div>
